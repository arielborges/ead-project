...
public class CourseUserController {
    ...
    public ResponseEntity<Object> saveSubscriptionUserInCourse(@PathVariable(value = "courseId")UUID courseId,
        ...
        if (courseUserService.existsByCourseIdAndUserId(courseModelOptional.get(),subscriptionDto.getUserId())){
    ...
    public ResponseEntity<Object> deletedUserCourseByUser(@PathVariable(value = "userId")UUID userId){
        if (!courseUserService.existsByUserId(userId)){
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("CourseUser not found!");
        }
        courseUserService.deletedUserCourseByUser(userId);
